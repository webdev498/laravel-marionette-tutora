...
class CreateLessonBookingForTutorCommandHandler extends CommandHandler
{
     ...
     * Handle the command.
     *
     * @param  CreateLessonBookingForTutorCommand  $command
     * @return mixed
     */
    public function handle(CreateLessonBookingForTutorCommand $command)
    {
        return $this->database->transaction(function () use ($command) {

            $tutor        = $this->getTutor($command->tutorId);
    ...
    protected function getTutor($tutorId = null)
    {
        $tutor = $this->findUser($tutorId);
     ...
     * @return void
     */
    protected function guardAgainstInvalidData(CreateLessonBookingForTutorCommand $command)
    {
