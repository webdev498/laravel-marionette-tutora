...
@section('heading')
    Payment received for your lesson with {{ $relationship->tutor->first_name }} 
@stop

@section('body')
    Hey {{ $relationship->student->first_name }},<br>
    <br>
    We hope your recent lesson with {{ $relationship->tutor->first_name }} went well. We wanted to let you know that we have received your payment for this lesson, and have attached your invoice below:<br>
@stop
