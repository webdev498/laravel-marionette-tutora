...
@section('heading')
    Your DBS Check will expire in one week.
@stop

@section('body')
    Hey {{ $user->first_name }},<br>
    <br>
    Your DBS check will expire in one week. This means that we will no longer display your Check on your profile page. 
    <br>
    <br>
