...
@section('heading')
    Your lesson with {{ $relationship->student->first_name }} has been confirmed.
@stop

@section('body')
    Hey {{ $relationship->tutor->first_name }},<br>
    <br>
    Good news! {{ $relationship->student->first_name }} has confirmed your upcoming lesson. The details of your lesson are:<br>
@stop
