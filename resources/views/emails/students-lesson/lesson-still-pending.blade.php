...
@section('heading')
    Reminder: Please confirm your upcoming lesson
@stop

@section('body')
    Hey {{ $relationship->student->first_name }},<br>
    <br>
    You have not confirmed your lesson with {{ $relationship->tutor->first_name }}. Please confirm it by following the link below.<br>
@stop
...
@section('action')
    ...
    ]) }}" class="btn__anchor" style="color:#ffffff !important; text-decoration: none !important;">Confirm lesson</a>
@stop
