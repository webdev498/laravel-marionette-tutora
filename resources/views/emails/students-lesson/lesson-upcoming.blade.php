...
@section('heading')
    Reminder: Your lesson with {{ $relationship->tutor->first_name }} is tomorrow
@stop

@section('body')
    Hey {{ $relationship->student->first_name }},<br>
    <br>
    This is a friendly reminder that you have an upcoming lesson with {{ $relationship->tutor->first_name }} is tomorrow.
@stop
