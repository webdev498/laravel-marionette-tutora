        ...
        <div class="wrapper">
            <div class="[ layout layout--center ] page-head__body"><!--
                --><div class="[ layout__item ] page-head__main">
                    ...
                    <h3 class="subheading gamma">For Tutors</h3>
                </div><!--

                --><div class="[ layout__item ] page-head__aside">
                    <a href="{{ relroute('tutor.index') }}" class="btn btn--full">Become a tutor</a>
                </div><!--
            --></div>
        </div>
    </header>
            ...
            --><div class="[ layout__item ] faqs__links">
                <ul class="[ list-ui list-ui--bare list-ui--compact ]">
                    @foreach (trans('faqs.tutor') as $faq)
                        <li>
                            <a href="{{ route('faqs.tutor').'#'.str_slug(array_get($faq, 'heading')) }}">
